...
export default function YouTubeVideoWaitlist() {
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <p className="text-zinc-400 text-sm mt-1">
              YouTube → MP4 in HD. Join the waitlist to get early access.
            </p>
          </div>
        </div>
              ...
              {status === "success" ? (
                <div className="flex flex-col items-center gap-3 py-4 text-center">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">
                    We'll email you the moment YouTube Video Downloader goes
                    live.
                  </p>
                </div>
              ) : (
            ...
            <div className="border border-zinc-200/60 shadow-xl shadow-zinc-200/20 rounded-[32px] overflow-hidden bg-white min-h-[520px] flex flex-col items-center justify-center p-12 text-center space-y-8">
              ...
              <div className="space-y-3 max-w-sm">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  We're putting the finishing touches on our YouTube Video
