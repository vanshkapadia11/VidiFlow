...
export default function InstagramWaitlist() {
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <h1 className="text-4xl font-black tracking-tight text-zinc-900 italic uppercase">
              InstaRip<span className="text-red-600">.</span>
            </h1>
            <p className="text-zinc-400 text-sm mt-1">
              Instagram → MP4 in HD. Join the waitlist to get early access.
            </p>
          </div>
        </div>
              ...
              {status === "success" ? (
                <div className="flex flex-col items-center gap-3 py-4 text-center">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">
                    We'll email you the moment Instagram Downloader goes live.
                  </p>
                </div>
              ) : (
          ...
          <div className="lg:col-span-8">
            <div className="border border-zinc-200/60 shadow-xl shadow-zinc-200/20 rounded-[32px] overflow-hidden bg-white min-h-[520px] flex flex-col items-center justify-center p-12 text-center space-y-8">
              <div className="relative">
                ...
                <div className="relative w-28 h-28 rounded-3xl bg-gradient-to-br from-pink-500 to-red-600 flex items-center justify-center shadow-2xl shadow-pink-200 rotate-3">
              ...
              <div className="space-y-3 max-w-sm">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  We're putting the finishing touches on our Instagram
              ...
              <div className="flex items-center gap-3 flex-wrap justify-center">
                {["Reels", "Stories", "No Signup", "Free Forever"].map(
                  (tag) => (
                    <div
                      key={tag}
