...
const plannedFeatures = [
  "320kbps high-fidelity MP3",
  "Auto metadata & album art",
  "Lossless audio extraction",
  "YouTube Shorts support",
  "Fast high-speed proxy downloads",
];

export default function YouTubeAudioComingSoon() {
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-10 gap-4">
          ...
          <div className="hidden md:flex items-center gap-6 text-zinc-400 border-l border-zinc-200 pl-6 lowercase italic">
            <div>
              ...
              <p className="text-sm font-bold text-zinc-600">In Development</p>
            </div>
          </div>
        </div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-12 text-center space-y-8">
                ...
                <div className="space-y-3 max-w-sm">
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    We&apos;re building a blazing-fast YouTube to MP3 converter
                    with 320kbps quality. Check back soon!
                  </p>
                </div>
                ...
                <div className="w-full max-w-xs pt-2">
                  ...
                  <div className="flex flex-col gap-2">
                    {[
                      {
                        label: "Pinterest Video Downloader",
